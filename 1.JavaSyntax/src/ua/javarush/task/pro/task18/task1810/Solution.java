...
Requirements:
1. У методі toStringArray(ArrayList<String>) для списку, отриманого як аргумент, потрібно викликати метод toArray(), в
який передається посилання на конструктор масиву, тип якого відповідає типу списку.

...
парне число, і false, якщо таких чисел немає. Для пошуку чисел у потоці використай метод anyMatch() об'єкта типу Stream<Integer>.

Метод hasOnlyPositiveNumbers(Stream<Integer>) повертає true, якщо у вхідному потоці є тільки додатні числа, і false,
якщо є щонайменше одне від'ємне число. Для пошуку чисел у потоці використай метод allMatch() об'єкта типу Stream<Integer>.

...
addToList(Runnable), який додає у список list елемент, отриманий як вхідний параметр, і метод runList(),
який викликає метод run() для кожного елемента списку list.
...
Requirements:
1. У публічному статичному методі void addToList(Runnable) потрібно додавати у список list елемент,
отриманий як вхідний параметр.

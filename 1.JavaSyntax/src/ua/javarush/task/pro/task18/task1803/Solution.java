...
// Collections.sort(ArrayList<JavaRushMentor>, Comparator<JavaRushMentor>), в який передається список менторів mentors
// і компаратор сортування.
//
//Твоє завдання — реалізувати цей компаратор. Для цього в класі NameComparator слід імплементувати інтерфейс
// Comparator<JavaRushMentor> і реалізувати метод int compare(JavaRushMentor mentor1, JavaRushMentor mentor2),

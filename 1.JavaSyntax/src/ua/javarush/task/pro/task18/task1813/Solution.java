...
Майбутнє — за електромобілями
Сучасний світ відмовляється від двигунів внутрішнього згоряння, і ера електромобілів не за горами.
Потрібно, щоб наша програма могла відокремити електромобілі від усіх інших автомобілів.
Для цього є метод onlyElectricCars(ArrayList<Car>), який фільтрує список автомобілів,
отриманий як вхідний параметр. Цей метод повертає потік відфільтрованих даних, а саме потік автомобілів, у
яких поле isElectric дорівнює true. У цьому тобі допоможе метод filter() об'єкта типу Stream<Car>.

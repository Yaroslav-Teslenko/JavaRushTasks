...
Потрібно, щоб метод getFilteredStrings(Stream<String>) перетворював вхідний потік рядків на множину рядків,
довжина яких перевищує шість символів.
...
Requirements:
1. У публічному статичному методі getFilteredStrings(Stream<String>) потрібно викликати статичний метод toSet() класу Collectors.

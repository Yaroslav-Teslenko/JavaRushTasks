...
використовується метод Collections.sort(ArrayList<Integer>, Comparator<Integer>), де параметри — це список чисел і компаратор.

Твоє завдання — переписати реалізацію методу sortNumbers(ArrayList<Integer>) так, щоб замість внутрішнього анонімного
класу Comparator<Integer> використовувався лямбда-вираз.

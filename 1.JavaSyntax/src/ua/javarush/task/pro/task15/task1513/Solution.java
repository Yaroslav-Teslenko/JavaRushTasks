...
/* 
Дивися в корінь
Напиши програму, в якій користувач уводить з клавіатури шлях до файлу або папки, після
чого в консоль виводиться шлях до диска (корінь для шляху в стилі Unix), на якому розташовано
цей файл (або папку).

...
У нас є клас Programmer, а в ньому є дуже важливе поле — salary. Наше завдання таке: треба додати можливість отримати й
 змінити значення цього поля за допомогою гетера й сетера.
Але є нюанс: зарплату можна тільки підвищувати. Отож тобі потрібно додати в сетер перевірку: якщо значення аргументу
більше за поточне, то поле salary змінюємо, інакше — ігноруємо.

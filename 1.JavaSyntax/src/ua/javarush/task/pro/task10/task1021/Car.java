...
Створімо каталог нових моделей автомобілів на нашому підприємстві. Для цього нам потрібно створити один метод
initialize, який ініціалізуватиме такі поля об'єкта типу Car: модель, рік випуску, колір.

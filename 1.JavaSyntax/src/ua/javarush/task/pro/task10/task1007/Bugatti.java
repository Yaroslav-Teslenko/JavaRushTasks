...
Ти зробив попереднє замовлення на новеньку Bugatti рівно пів року тому. Зараз червень, саме час їздити на
кабріолеті. Але ти забув, який тип кузова вибрав під час замовлення.
Твоє завдання — додати функціональність для отримання поточної конфігурації та для її
зміни в разі потреби. Для цього створи гетери й сетери.

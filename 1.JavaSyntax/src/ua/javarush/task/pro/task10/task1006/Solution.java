...
Тобі потрібно в конструкторах спадкоємців класу Car передати тип автомобіля в конструктор базового
(батьківського) класу, використовуючи super("тип автомобіля"). Для цього в класі Solution у
методі main створи 3 об'єкти: HybridCar, GasCar і ElectricCar.

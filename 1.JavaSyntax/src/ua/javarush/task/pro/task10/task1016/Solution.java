...
/* 
Прогноз погоди
Клас City має два поля — назва міста й поточна температура повітря. Крім того, клас Solution містить метод
showWeather, який виводить у консоль інформацію про погоду в місті, переданому як аргумент методу. Реалізуй
метод showWeather, який має виводити в консоль інформацію в такому форматі: У місті "назва міста" сьогодні
температура повітря "температура в місті"

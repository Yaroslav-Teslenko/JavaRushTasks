...
/* 
Створімо хмарочос
Спробуймо спорудити свій перший хмарочос і оголосити про результат виконання в консолі.
Для цього тобі потрібно викликати конструктор класу Skyscraper в методі main і в тілі
конструктора вивести в консоль текст "Хмарочос побудовано.".

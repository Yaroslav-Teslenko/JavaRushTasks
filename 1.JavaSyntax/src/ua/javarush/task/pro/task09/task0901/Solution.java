...
У класі Solution оголошено чотири публічних поля, що відповідають чотирьом цілочисловим типам.
 Під час оголошення ці поля ініціалізуються різними значеннями — цілочисловими літералами.
Проте програма не компілюється, і це потрібно виправити. Для цього зміни значення полів так,
щоб тип змінної відповідав типу цілочислового літерала.

...
Requirements:
1. Потрібно вивести на екран індекс першого символу першого шуканого слова (другий параметр методу) в рядку (перший параметр методу).
2. Потрібно вивести на екран індекс першого символу останнього шуканого слова (другий параметр методу) в рядку (перший параметр методу).
*/

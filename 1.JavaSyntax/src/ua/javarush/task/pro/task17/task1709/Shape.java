package ua.javarush.task.pro.task17.task1709;
...
Requirements:
1. Клас Shape має бути абстрактним.
2. Клас Shape має містити абстрактний метод double getPerimeter().
3. Клас Shape має містити абстрактний метод double getArea().
*/

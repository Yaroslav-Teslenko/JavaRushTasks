...
(і, отже, виводяться в консоль) рік і місяць. Тобто неправильна дата містить завжди дві
помилки (рік і місяць), які тобі потрібно виправити в методі fixDate, враховуючи ці умови:
1. Якщо дата більша за поточну, в ній потрібно виправити ці дві помилки (рік і місяць) за
допомогою методів setYear, setMonth. Рік задається з 1900, а місяці нумеруються з нуля.
...
//                Date brokenDate=brokenDates.get(i);
//                brokenDates.set(i, new Date(brokenDate.getYear()-1900, brokenDate.getMonth()-1, brokenDate.getDay()));
//            }
//        }

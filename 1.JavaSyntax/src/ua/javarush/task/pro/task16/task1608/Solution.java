...
/* 
Просто день тижня
Реалізуй метод getDayOfWeek(LocalDate date) так, щоб він повертав українську назву
дня тижня з аргументу date. Скористайся методами getDayOfWeek і getDisplayName.
Приклад параметрів методу getDisplayName для отримання української назви дня
тижня: getDisplayName(TextStyle.FULL, Locale.forLanguageTag("uk"))

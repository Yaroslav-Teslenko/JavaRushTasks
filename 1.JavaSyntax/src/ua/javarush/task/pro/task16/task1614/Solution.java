...
у методі getMaxFromMilliseconds поверни максимальний Instant,
який можна отримати за допомогою методу ofEpochMilli(long milliseconds);

- у методі getMaxFromSeconds поверни максимальний Instant, який можна отримати
за допомогою методу ofEpochSecond(long seconds);

- у методі getMaxFromSecondsAndNanos поверни максимальний Instant, який можна отримати за
допомогою методу ofEpochSecond(long seconds, long nanos).

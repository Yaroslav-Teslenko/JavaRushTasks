...
Що спільного у всіх часових зон і Пекіна? Правильно! Вони дадуть нам змогу потренуватися у використанні класів
ZoneId і ZonedDateTime :) Реалізуй два методи:
...
public class Solution {
    ...
    static TreeSet<String> getSortedZones() {
        ...
        TreeSet<String> allZ= new TreeSet<>();
        allZ.addAll(ZoneId.getAvailableZoneIds());
        return allZ;
    }

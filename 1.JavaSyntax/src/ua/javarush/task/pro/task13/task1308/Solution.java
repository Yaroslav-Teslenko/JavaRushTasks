...
У класі Solution оголошено методи: min(ArrayList<Integer>), max(ArrayList<Integer>), frequency(ArrayList<Integer>, Integer), binarySearch(ArrayList<Integer>, Integer). Ти маєш розібратися, що саме роблять ці методи, і переписати їхній код, використовуючи тільки відповідні методи класу Collections.
...
3. Клас Solution має містити публічний статичний метод frequency(ArrayList<Integer>, Integer), який повертає значення типу int.
4. Клас Solution має містити публічний статичний метод binarySearch(ArrayList<Integer>, Integer), який повертає значення типу int.

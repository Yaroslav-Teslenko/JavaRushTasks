...
Настав час розкрити всі карти і зрозуміти, як насправді працює enum. Тобі потрібно з enum Month зробити
class, а також додати й реалізувати методи ordinal() і values().

...
У класі Solution є методи printHashSet(HashSet<String>) і printList(ArrayList<String>), які виводять усі
елементи з переданих колекцій — списку та множини — з нового рядка. Твоє завдання — переписати ці методи,
використовуючи цикл for-each.

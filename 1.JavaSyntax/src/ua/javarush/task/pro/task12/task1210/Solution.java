...
Ти бачиш робочу програму, в якій масив int[] numbers заповнюється числами в методі init(). Потім у
методі reverse() відбувається переставляння чисел у зворотному порядку.

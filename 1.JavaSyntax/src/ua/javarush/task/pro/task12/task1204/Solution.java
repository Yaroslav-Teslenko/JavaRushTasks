...
/* 
Сплата за рахунками
У класі Solution є поле balance, яке описує баланс коштів на банківському рахунку.
Під час оголошення проініціалізуй його значенням Integer.MAX_VALUE.
...
public class Solution {
    ...
    public static void processPayment(String bill) {
        ...
        Solution.balance = Solution.balance - Integer.parseInt(bill);
    }
}

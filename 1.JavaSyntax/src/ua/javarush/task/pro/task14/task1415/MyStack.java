...
Всі елементи зберігаються в приватному списку storage. Твоє завдання — реалізувати всі оголошені методи класу MyStack,
де метод push(String) додає елемент у початок списку storage;

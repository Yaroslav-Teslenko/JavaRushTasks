...
Методи parseInt і get можуть генерувати винятки NumberFormatException і ArrayIndexOutOfBoundsException.
Обгорни їх одним блоком try із двома блоками catch.
Блок catch для NumberFormatException має виводити повідомлення: "Потрібно ввести ціле число",
а блок catch для ArrayIndexOutOfBoundsException має виводити повідомлення: "Студента з таким номером не існує".

...
2. У блоці catch у консоль має бути виведено змінну answer, щоб після введення з клавіатури "ок"
усі введені раніше рядки виводилися в консоль у зворотному порядку.
